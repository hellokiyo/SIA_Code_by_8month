  ...
  <!--
   ...
   -->
    ...
    -->
      ...
      <!-- 지금 가장 핫한 게시물 -->
      <div>
        <h5 class="fw-bold mb-3">지금 가장 핫한 게시물 🔥</h5>
        <div class="d-flex flex-row overflow-auto">
    ...
    <div class="fixed-bottom d-md-none bg-white border-top">
      <div class="menu menu-row d-flex justify-content-around py-2 fs-6 fw-bold cursor-pointer">
        <div class="menu-item flex-column align-items-center flex-fill tab-btn"
          ...
          <span class="menu-icon mb-1"><i class="ki-duotone ki-home fs-2x"></i></span>
          <span class="menu-title">홈</span>
        </div>
        <div class="menu-item flex-column align-items-center flex-fill tab-btn"
             :class="{active: activeTab=='course'}"
             @click="tabButtonClicked('course')">
          <span class="menu-icon mb-1"><i class="ki-duotone ki-map fs-2x"></i></span>
          <span class="menu-title">코스</span>
        </div>
        <div class="menu-item flex-column align-items-center flex-fill tab-btn"
             :class="{active: activeTab=='danger'}"
             @click="tabButtonClicked('danger')">
          <span class="menu-icon mb-1"><i class="ki-duotone ki-warning fs-2x"></i></span>
          <span class="menu-title">위험신고</span>
        </div>
        <div class="menu-item flex-column align-items-center flex-fill tab-btn"
             :class="{active: activeTab=='ment'}"
             @click="tabButtonClicked('ment')">
          <span class="menu-icon mb-1"><i class="ki-duotone ki-people fs-2x"></i></span>
          <span class="menu-title">멘트</span>
        </div>
      </div>
    </div>
  </div>
