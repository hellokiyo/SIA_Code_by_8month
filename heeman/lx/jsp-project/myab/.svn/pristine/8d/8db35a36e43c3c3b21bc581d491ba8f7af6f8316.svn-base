...
<table border="1">
	<tr>
		<th>이 름</th>
		<td>
			<input type="text" name="abName" value="${ab.abID}">
		</td>	
	</tr>	
	...
	<tr>
		<th>email</th>
		<td>
			<input type="text" name="abEmail" value="${ab.abEmail}">
		</td>
	</tr>
	...
	<tr>
		<th>전화번호</th>
		<td>
			<input type="text" name="abTel" value="${ab.abTel}">
		</td>
	</tr>
	...
	<tr>
		<th>생 일</th>
		<td>
			<input type="date" name="abBirth" value="${ab.abBirth}%>">
		</td>
	</tr>
